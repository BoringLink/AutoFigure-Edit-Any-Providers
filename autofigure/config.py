...
class Config:
    ...
    generation_provider: str = "openrouter"  # openrouter, bianxie, gemini, openai, zhipuai, deepseek, siliconflow
    ...
    enhancement_provider: str = "openrouter"  # openrouter, bianxie, gemini, openai, zhipuai, deepseek, siliconflow
