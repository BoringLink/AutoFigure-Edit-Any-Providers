                            ...
                            <div className="af-form-group">
                                ...
                                <select
                                    ...
                                    onChange={e => {
                                        ...
                                        // Backend normalizes endpoint paths for OpenAI-compatible providers.
                                        const providerMeta = LLM_PROVIDERS[provider]
                                        updateConfig({
                                            imageGenProvider: provider,
                                            imageGenBaseUrl: providerMeta.defaultBaseUrl,
                                            imageGenModel: providerMeta.defaultModel,
                                        })
                                    }}
                                    className="af-input"
                                >
                            ...
                            <div className="af-form-group">
                                ...
                                <input
                                    ...
                                    placeholder={config.imageGenProvider === 'openrouter'
                                        ...
                                        : config.imageGenProvider === 'zhipuai'
                                        ? 'e.g., glm-4.7-flash'
                                        : config.imageGenProvider === 'openai'
                                        ? 'e.g., gpt-image-1'
                                        : 'e.g., gemini-3.1-flash-image-preview'}
                                    className="af-input"
                                />
                                    ...
                                    <select
                                        ...
                                        onChange={e => {
                                            ...
                                            updateConfig({
                                                ...
                                                enhancementLlmBaseUrl: providerMeta.defaultBaseUrl,
                                                enhancementLlmModel: providerMeta.defaultModel,
                                            })
                                        }}
                                        className="af-input"
                                    >
                                ...
                                <div className="af-form-group">
                                    ...
                                    <input
                                        ...
                                        placeholder={config.enhancementLlmProvider === 'openrouter'
                                            ...
                                            : config.enhancementLlmProvider === 'zhipuai'
                                            ? 'e.g., glm-4.7-flash'
                                            : config.enhancementLlmProvider === 'openai'
                                            ? 'e.g., gpt-4o-mini'
                                            : 'e.g., gemini-3.1-pro-preview'}
                                        className="af-input"
                                    />
