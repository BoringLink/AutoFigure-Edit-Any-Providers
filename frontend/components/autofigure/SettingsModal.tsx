                                        ...
                                        <div className="af-nested-form">
                                            <div className="af-form-row">
                                                    ...
                                                    <select
                                                        ...
                                                        onChange={e => {
                                                            ...
                                                            updateConfig({
                                                                ...
                                                                methodologyLlmBaseUrl: LLM_PROVIDERS[provider].defaultBaseUrl,
                                                                methodologyLlmModel: LLM_PROVIDERS[provider].defaultModel,
                                                            })
                                                        }}
                                                    >
                                                ...
                                                <div className="af-form-group">
                                                    ...
                                                    {config.methodologyLlmProvider === 'zhipuai' ? (
                                                        <select
                                                            className="af-input"
                                                        ...
                                                        <input
                                                            ...
                                                            placeholder={config.methodologyLlmProvider === 'openrouter'
                                                                ...
                                                                : config.methodologyLlmProvider === 'openai'
                                                                ? 'e.g., gpt-4o-mini'
                                                                : 'e.g., gemini-3.1-pro-preview'}
                                                        />
                                                    )}
                                    ...
                                    <select
                                        ...
                                        onChange={e => {
                                            ...
                                            updateConfig({
                                                ...
                                                baseUrl: provider === 'custom' ? '' : LLM_PROVIDERS[provider].defaultBaseUrl,
                                                model: provider === 'custom' ? '' : LLM_PROVIDERS[provider].defaultModel,
                                            })
                                        }}
                                    >
                                        {Object.entries(LLM_PROVIDERS).map(([key, value]) => (
                                ...
                                <div className="af-form-group">
                                    ...
                                    <input
                                        ...
                                        placeholder={
                                            ...
                                            ? 'e.g., model-name or full-model-id'
                                            : config.llmProvider === 'openrouter'
                                            ? 'e.g., google/gemini-3.1-pro-preview'
                                            : config.llmProvider === 'gemini'
                                            ? 'e.g., gemini-3.1-pro-preview'
                                            : config.llmProvider === 'zhipuai'
                                            ? 'e.g., glm-4.7-flash'
                            ...
                            <div className="af-form-row">
                                ...
                                <div className="af-form-group">
                                    <label className="af-label">
                                        {config.llmProvider === 'custom' ? 'Base URL (Required)' : 'Base URL (Optional)'}
                                    </label>
                                    <input
                                        type="text"
                                        className="af-input"
