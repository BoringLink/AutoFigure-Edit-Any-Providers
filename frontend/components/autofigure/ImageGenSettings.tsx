...
export default function ImageGenSettings({
    ...
    const handleProviderChange = (provider: LLMProvider) => {
        ...
        const defaultBaseUrl = providerMeta?.defaultBaseUrl || 'https://api.bianxie.ai/v1'
        const defaultModel = providerMeta?.defaultModel || 'gemini-3.1-flash-image-preview'
    ...
    const getPlaceholders = () => {
        ...
        if (localConfig.provider === 'zhipuai') {
            return {
                apiKey: 'Enter your ZhipuAI API key',
        ...
        if (localConfig.provider === 'deepseek') {
            return {
                apiKey: 'Enter your DeepSeek API key',
                model: 'e.g., deepseek-chat',
                baseUrl: 'https://api.deepseek.com/v1',
            }
        }
        if (localConfig.provider === 'siliconflow') {
            return {
                apiKey: 'Enter your SiliconFlow API key',
